      ...
      highlights: [
        {
          ...
          description: 'Rebuilt B2B dashboard, improving Lighthouse score from 50 to 89.',
        },
        {
        ...
        },
        {
          ...
          description: "Built 'Barter-box' for campaign creation and applicant tracking.",
        },
        {
        ...
        },
        {
          ...
          description: 'Integrated payment system with error handling and redirection.',
        },
      ],
    },
  ];
              ...
              <div className="p-8 rounded-[18px] bg-background/80 backdrop-blur-xl border border-black/[0.08] dark:border-white/[0.08]">
                <div className="flex flex-wrap items-start justify-between gap-4 mb-6 pb-6 border-b border-black/[0.08] dark:border-white/[0.08]">
                  <div>
                    ...
                    <p className="text-[15px] sm:text-[16px] lg:text-[17px] text-foreground/80 mb-2">{exp.role}</p>

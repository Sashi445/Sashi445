      ...
      <div className="max-w-[980px] mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
                ...
                >
                  ...
                  <div className="pt-1">
                    ...
                    {info.link ? (
                      ...
                      <p className="text-[15px] text-foreground/80">{info.value}</p>
                    )}
                  </div>
                </motion.div>
              ))}
            ...
            <div>
              <h4 className="text-[17px] font-semibold text-foreground mb-4">Connect With Me</h4>

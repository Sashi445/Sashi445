...
export function AppleSkills() {
  const skillCategories = [
    ...
    {
      title: 'Backend',
      skills: ['NodeJS', 'ExpressJS', 'Spring Boot', 'Kafka', 'MongoDB'],
    },
    {
      title: 'Big Data & ML',
      skills: ['Spark', 'Hadoop', 'PyTorch', 'TensorFlow'],
    },
    {
      title: 'Tools & Platforms',
      skills: ['Linux', 'GitHub', 'Git', 'Docker', 'AWS', 'CI/CD'],
    },
  ];
      ...
      <div className="max-w-[980px] mx-auto px-6">
        ...
        >
          <p className="text-[15px] text-muted-foreground max-w-[640px] mx-auto">
            Continuously learning and exploring new technologies to stay at the forefront of
            software development and AI/ML innovation.
          </p>
        </motion.div>
      </div>
    </section>
